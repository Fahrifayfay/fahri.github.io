    ...
    */
    const MANUAL_SYNC_TIMES = {
      ...
      4: [
        ...
        {time:"1:15.5", text:"I know it hurts you"},
        {time:"1:18.5", text:"But I need to tell you something"},
        {time:"1:29.5", text:"My heart just can't be faithful for long"},
        {time:"1:40", text:"I swear I'll only make you cry"},
        {time:"1:49", text:"Maybe I'd change for you someday"},
        {time:"1:55.5", text:"But I can't help the way I feel"},
        {time:"2:02.5", text:"Wish I was good"},
        {time:"2:00.2", text:"Wish that I could give you my love now"},
        {time:"2:12.3", text:"But I need to tell you something"},
